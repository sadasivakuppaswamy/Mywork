...
/**
 * Created by Sadasiva.Kuppaswamy on 10-02-2016.
 */
public class RestFirstTest {
    public static void main (String args[]) throws JSONException {

// This is request which we are sending to server
         String restURL_XML="http://cpfarm:8001/projects/cpg1_benefit/tags/cp.zip";
...
// sending request and we are passing parameter in url itself
     ...
     //   String restURL_JSON = "http://api.openweathermap.org/data/2.5/weather?q=Amsterdam";
        String restURL_JSON="http://cpfarm:8001/projects/cpg1_benefit/tags/latest";
        try {
